package com.pino.project.ocp11.java11.ocp.chapter18.concurrency.forkjoin;
...
/**
 * Example of ForkJoin framework (removed from OCP11 Exam).
 */
    ...
    protected synchronized void compute() {
        if(end-start <= 3) {
            for(int i=start; i<end; i++) {
                ...
                System.out.println("-->fork subtask[start="+start+",end="+end+"] Animal " + i + " Weighed " + weights[i] + " kg, executed by " +Thread.currentThread().getName()+". ");
            }
